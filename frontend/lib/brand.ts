...
export const ourWay = {
  kicker: "داستان و راه ما",
  title: "راه ما",
  lead: "مرد کوهستان از دل طبیعت شکل گرفت؛ مسیری که ریشه در خاک دارد و طبیعت را به سفره‌های امروز بازمی‌گرداند.",
  note: "مرد کوهستان تولیدکننده فرآورده‌های پروتئینی سالم و باکیفیت است؛ محصولاتی که با تکیه بر فرآیندهای دقیق، استانداردهای تخصصی و احترام به طبیعت شکل می‌گیرند.",
  moreHref: "/way",
  moreLabel: "ادامه راه",
  steps: [
    {
      id: "origin",
      title: "راهی که از کوهستان آغاز شد",
      body: "مرد کوهستان از دل طبیعت شکل گرفت؛ مسیری که ریشه در خاک دارد و طبیعت را به سفره‌های امروز بازمی‌گرداند.",
      scene: "/brand/our-way-01-climb.png",
      sceneAlt: "مرد کوهستان در حال صعود از مسیر کوهستانی",
      side: "east",
      pose: "climb",
    },
    {
      id: "nature",
      title: "اصیل همچون طبیعت",
      body: "این مسیر، به شفافی و روشنی طبیعت است. طبیعت اصلی‌ترین راهنمای ما در پرورش و تولید تک‌تک محصولات است.",
      scene: "/brand/our-way-02-nature.png",
      sceneAlt: "مرد کوهستان در مرتع کنار گاو و گوسفند",
      side: "west",
      pose: "pasture",
    },
    {
      id: "quality",
      title: "کیفیتی که ساخته می‌شود",
      body: "برتری در جزئیات شکل می‌گیرد؛ در دقت، در انتخاب و از همه‌ مهم‌تر مسیری که آن را تضمین می‌کند.",
      scene: "/brand/our-way-03-quality.png",
      sceneAlt: "مرد کوهستان در حال آماده‌سازی با دقت و کیفیت",
      side: "east",
      pose: "craft",
    },
    {
      id: "balance",
      title: "مسیری برای امروز و فردا",
      body: "طبیعت بزرگ‌ترین نمونه تعادل است؛ برای همین در مسیرمان سلامت امروز و پایداری طبیعت در آینده را در کنار هم در نظر می‌گیریم.",
      scene: "/brand/our-way-04-balance.png",
      sceneAlt: "مرد کوهستان در تعادل با دام و طبیعت",
      side: "west",
      pose: "tend",
    },
    {
      id: "ahead",
      title: "همیشه یک قدم جلوتر",
      body: "در هر قدم از این مسیر، راه‌حل‌های تازه را دنبال می‌کنیم تا همیشه تجربه‌ای فراتر از انتظار خلق کنیم.",
      scene: "/brand/our-way-05-ahead.png",
      sceneAlt: "پایین آمدن از مسیر کوه به سوی زندگی امروز",
      side: "east",
      pose: "descend",
    },
  ],
