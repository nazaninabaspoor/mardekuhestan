...
/** بشقاب‌های برند — برای دسته‌هایی که هنوز عکس سینی واقعی نداریم */
const PLATE = {
...
/** لیبل کامل بسته‌بندی — بدون برش */
const PACK = {
  burgerChicken: "/brand/v2/products/prod-01.png",
  burgerBeef: "/brand/v2/products/prod-02.png",
  shank: "/brand/v2/products/prod-03.png",
  wingDrum: "/brand/v2/products/prod-04.png",
  breast: "/brand/v2/products/prod-05.png",
  burgerThick: "/brand/v2/products/prod-06.png",
  shankAlt: "/brand/v2/products/prod-07.png",
  fillet: "/brand/v2/products/prod-08.png",
  breastAlt: "/brand/v2/products/prod-09.png",
  breastFillet: "/brand/v2/products/prod-10.png",
  saffronChicken: "/brand/v2/products/prod-11.png",
  chops: "/brand/v2/products/prod-12.png",
  steakLean: "/brand/v2/products/prod-13.png",
  shoulder: "/brand/v2/products/prod-14.png",
  wings: "/brand/v2/products/prod-15.png",
  burgerAlt: "/brand/v2/products/prod-16.png",
  roast: "/brand/v2/products/prod-17.png",
  cubes: "/brand/v2/products/prod-18.png",
  nugget: "/brand/v2/products/prod-19.png",
  cubesAlt: "/brand/v2/products/prod-20.png",
  wingMarinated: "/brand/v2/products/prod-21.png",
  mince: "/brand/v2/products/prod-22.png",
  saffronAlt: "/brand/v2/products/prod-23.png",
  schnitzel: "/brand/v2/products/prod-24.png",
  steak: "/brand/v2/products/prod-25.png",
  steakAlt: "/brand/v2/products/prod-26.png",
  schnitzelAlt: "/brand/v2/products/prod-27.png",
  schnitzelFlat: "/brand/v2/products/prod-28.png",
} as const;
...
export const homeDoors = [
  {
    ...
    image: PACK.steak,
    alt: "گوشت تازه مرد کوهستان — سینی استیک",
  },
  {
    id: "seafood",
  ...
  },
  {
    ...
    tint: "#861309",
    story:
      "ناگت، همبرگر و شنیتسل؛ وقتی سرعت مهم است اما طعم نباید قربانی شود.",
    image: PACK.schnitzel,
    alt: "آماده‌پخت مرد کوهستان — سینی شنیتسل",
  },
  {
    id: "ready-meal",
    href: "/products?cat=ready",
  ...
  },
  {
    ...
    image: PACK.breast,
    alt: "مرغ و طیور مرد کوهستان — سینی سینه مرغ",
  },
  {
    id: "frozen",
    href: "/products?cat=ready",
...
export const homeCategoryProducts = {
  "fresh-meat": [
    {
      ...
      name: "ماهیچه",
      note: "برش تازه",
      teaser: "برشی از مرتع؛ برای پخت آرام و خورشت خانه.",
      story:
        "ماهیچه از مسیری می‌آید که می‌شود فهمید از کجا آمده. برش تازه، مناسب پخت آرام خانه و جمعهٔ خانوادگی.",
      href: "/products?cat=fresh-meat",
      image: PACK.shank,
    ...
    },
    {
      ...
      story:
        "شانه برای وقتی است که وقت دارید با حوصله بپزید. طعم عمیق می‌گیرد و خانه را پر از عطر می‌کند.",
      href: "/products?cat=fresh-meat",
      image: PACK.shoulder,
    ...
    },
    {
      ...
      name: "شیشلیک",
      note: "آماده پخت",
      teaser: "دنده با استخوان؛ آماده برای آتش و سیخ.",
      story:
        "شیشلیک طوری آماده شده که فقط حرارت درست می‌خواهد. طعم مرتع را تا سفره نگه می‌دارد.",
      href: "/products?cat=fresh-meat",
      image: PACK.chops,
    ...
    },
    {
      ...
      name: "گوشت خورشتی",
      note: "انتخاب هفته",
      teaser: "مکعب‌های تازه برای چند وعدهٔ هفته.",
      story:
        "گوشت خورشتی برای خانواده‌ای است که می‌خواهد یک خرید، چند پخت داشته باشد؛ تازه و قابل اعتماد.",
      href: "/products?cat=fresh-meat",
      image: PACK.cubesAlt,
    ...
    },
    {
      ...
      name: "استیک",
      note: "برای جمعه",
      teaser: "برش درشت؛ برای گریل و سفرهٔ جمعه.",
      story:
        "استیک برای وقتی که خانه بوی کباب می‌گیرد و همه دور میز جمع می‌شوند.",
      href: "/products?cat=fresh-meat",
      image: PACK.roast,
    ...
    },
    {
      ...
      name: "فیله",
      note: "لطیف",
      teaser: "برش لطیف برای پخت سریع و مجلسی.",
      story:
        "فیله برای وقتی که بافت نرم و پخت دقیق می‌خواهید؛ روشن و نزدیک به سفره.",
      href: "/products?cat=fresh-meat",
      image: PACK.fillet,
    ...
    },
    {
      ...
      name: "استیک ممتاز",
      note: "رتبه A+",
      teaser: "ماربلینگ واضح؛ برای گریل دقیق.",
      story:
        "استیک ممتاز با بافتی که روی حرارت زنده می‌شود؛ انتخابی برای سفرهٔ خاص هفته.",
      href: "/products?cat=fresh-meat",
      image: PACK.steak,
    ...
    },
    {
      ...
      name: "گوشت قیمه‌ای",
      note: "خرده‌برش",
      teaser: "مکعب‌های یکدست برای قیمه و خورشت.",
      story:
        "گوشت قیمه‌ای با برش یکدست؛ برای خورشت‌هایی که باید طعم عمیق بگیرند.",
      href: "/products?cat=fresh-meat",
      image: PACK.cubes,
  ...
  "cook-ready": [
    ...
    },
    {
      ...
      name: "همبرگر گوشت",
      note: "خانه",
      teaser: "پتی گوشت قرمز؛ طعم خانه را حفظ می‌کند.",
      story:
        "همبرگر آماده‌پخت برای وقتی که دلتان برگر می‌خواهد، اما مسیر غذا برایتان مهم است.",
      href: "/products?cat=ready",
      image: PACK.burgerBeef,
    ...
    },
    {
      ...
      name: "شنیتسل",
      note: "سوخاری",
      teaser: "فیله سوخاری؛ فقط حرارت درست می‌خواهد.",
      story:
        "شنیتسل آماده‌پخت با پوشش ترد؛ برای شب‌هایی که دور هم می‌نشینید.",
      href: "/products?cat=ready",
      image: PACK.schnitzel,
    ...
    },
    {
      ...
      name: "همبرگر مرغ",
      note: "سبک‌تر",
      teaser: "پتی مرغ؛ سبک‌تر از گوشت قرمز.",
      story:
        "همبرگر مرغ برای وعده‌های سبک‌تر؛ همان سرعت، با طعمی که به خانه می‌رسد.",
      href: "/products?cat=ready",
      image: PACK.burgerChicken,
    ...
    },
    {
      ...
      name: "فیله سوخاری",
      note: "تخت",
      teaser: "برش تخت سوخاری؛ پخت یکدست.",
      story:
        "فیله سوخاری تخت برای وقتی که می‌خواهید سریع، ترد و مطمئن بپزید.",
      href: "/products?cat=ready",
      image: PACK.schnitzelFlat,
  ...
  poultry: [
    ...
    },
    {
      ...
      story:
        "بال و بازو مرغ با طعمی که همه می‌شناسند؛ مناسب پخت‌های خانگی و دورهم‌نشینی.",
      href: "/products?cat=fresh-meat",
      image: PACK.wingDrum,
      alt: "سینی مرغ — بال و بازو",
    },
    {
      id: "poultry-fillet",
      name: "فیله سینه",
      note: "بدون استخوان",
      teaser: "برش تمیز برای پخت سریع و سالم.",
      story:
        "فیله سینه برای خانواده‌ای که می‌خواهد یک خرید، چند پخت سبک داشته باشد.",
      href: "/products?cat=fresh-meat",
      image: PACK.breastFillet,
      alt: "سینی مرغ — فیله سینه",
    },
    {
      id: "poultry-wing",
      name: "بال مرغ",
      ...
      href: "/products?cat=fresh-meat",
      image: PACK.wings,
      alt: "سینی مرغ — بال مرغ",
    },
    {
      id: "poultry-saffron",
      name: "جوجه زعفرانی",
      note: "چاشنی‌دار",
      teaser: "مرغ زعفرانی؛ آماده برای سیخ و فر.",
      story:
        "جوجه زعفرانی با چاشنی روشن؛ برای وقتی که بوی زعفران خانه را پر می‌کند.",
      href: "/products?cat=fresh-meat",
      image: PACK.saffronChicken,
      alt: "سینی مرغ — جوجه زعفرانی",
    },
    {
      id: "poultry-wing-marinated",
      name: "بال چاشنی‌دار",
      note: "آماده کباب",
      teaser: "بال با چاشنی نارنجی؛ فقط حرارت می‌خواهد.",
      story:
        "بال چاشنی‌دار برای جمع‌های کوچک؛ طعم آماده، پخت سریع روی حرارت.",
      href: "/products?cat=fresh-meat",
      image: PACK.wingMarinated,
      alt: "سینی مرغ — بال چاشنی‌دار",
    },
  ],
  frozen: [
    {
