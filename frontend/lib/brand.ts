...
export const ourWay = {
  ...
  steps: [
    {
      id: "origin",
      title: "از کوهستان شروع شد",
      body: "اول قدم‌ها روی خاک سخت و هوای تازه بود؛ جایی که هنوز غذا بوی زمین می‌دهد.",
    ...
    {
      id: "nature",
      title: "کنار طبیعت مانده‌ایم",
      body: "دام و مرتع را جدا از هم نمی‌بینیم. آنچه می‌پروریم، باید سالم و سرحال بماند.",
    ...
    {
      id: "quality",
      title: "با دقت ساخته می‌شود",
      body: "کیفیت شعار نیست؛ در انتخاب، در زمان، و در کاری است که با دست و حوصله انجام می‌شود.",
    ...
    {
      id: "balance",
      title: "امروز را نگه می‌داریم",
      body: "به سفرهٔ امروز فکر می‌کنیم، بدون اینکه فردای طبیعت را فراموش کنیم.",
    ...
    {
      id: "ahead",
      title: "و باز یک قدم جلوتر",
      body: "هر بار راه را کمی بهتر می‌کنیم تا رسیدن غذا به خانه، ساده‌تر و مطمئن‌تر باشد.",
